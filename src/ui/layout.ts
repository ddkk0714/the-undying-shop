...
export const L = {
  ...
  live: {
    ...
    // 우하단 전경 (랜턴 든 팔). **화면 오른쪽 아래 모서리에 붙인다** (사용자 확정) —
    // 1440,470 이면 오른쪽 20px · 아래 42px 이 남아서 팔 끝이 허공에서 잘린 것처럼 보였다.
    // 모서리에 붙이면 화면 밖으로 자연스럽게 흘러 나간다 (1920-460, 1080-568)
    lantern: { x: 1460, y: 512, w: 460, h: 568 },
