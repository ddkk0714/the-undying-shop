...
export const L = {
  ...
  live: {
    ...
    enemy: { x: 1230, y: 400, w: 256, h: 256 },    // 적 CG — 512x512 의 정확히 1/2. 체력바가 바로 아래 붙는다
    // 우상단 흉상. **1:1 로 놓고 칸을 줄여 잘라낸다** — 배율을 낮추면(0.83배 등)
    // 도트가 지글거린다. 칸이 작아진 만큼 얼굴 위주로 더 바짝 잘린다
    portrait: { x: 1640, y: 190, w: 256, h: 248 },
    stats: { x: 1640, y: 446, w: 256, h: 252 },    // 초상 바로 아래 — 이름·공·방·체력
